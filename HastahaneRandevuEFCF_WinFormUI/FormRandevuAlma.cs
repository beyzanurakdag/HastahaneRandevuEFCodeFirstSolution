    ...
    public partial class FormRandevuAlma : Form
    {
        ...
        private void CiktiAlButonuAktifPasifliginiAyarla(Doktor dr, DateTime tarih)
        {
            ...
            if (dr!=null)
            {
                ...
                {
                    MessageBox.Show($"{dr.ToString()} adlı doktorun {tarih.ToString("dd.MM.yyyy")} tarihinde randevusu yoktur.Başka tarih seçiniz.","UYARI",MessageBoxButtons.OK,MessageBoxIcon.Hand);
                }
            }
        }
        ...
        private void btnCiktiAl_Click(object sender, EventArgs e)
        {
            try
            {
                printDocument1.DocumentName = "deneme";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                e.Graphics.DrawString($" {EnumManager.BransiTurkceStringOlarakVer(doktorum.Brans)} - {doktorum.ToString()} - {dateTimePickerCiktiAl.Value.ToString("dd.MM.yyyy")} tarihine ait ait randevular",new Font("Arial",10,FontStyle.Bold),Brushes.Black,new Point(25,100));
